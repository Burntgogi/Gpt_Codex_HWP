...
export function copyToOwnedExactBytes(input, copyObserver) {
    if (copyObserver !== undefined && typeof copyObserver !== "function") {
        throw new TypeError("copyObserver must be a function when provided.");
    }
    const view = asByteView(input);
...
export function createBoundedCopyObserver(maximumCopiedBytes, observer) {
    if (!Number.isSafeInteger(maximumCopiedBytes) ||
