...
import { HWP_CREATE_SVG_ASSET_TOOL_NAME, HWP_INSERT_IMAGE_TOOL_NAME, registerHwpCreateSvgAsset, registerHwpInsertImage, } from "./assets.js";
import { HWP_DETECT_FORMAT_TOOL_NAME, registerHwpDetectFormat, } from "./detect.js";
import { HWP_RENDER_PREVIEW_TOOL_NAME, registerHwpRenderPreview, } from "./preview.js";
import { HWP_FILL_FORM_TOOL_NAME, HWP_PATCH_DOCUMENT_TOOL_NAME, registerHwpFillForm, registerHwpPatchDocument, } from "./patch.js";
import { HWP_READ_TOOL_NAME, registerHwpRead } from "./read.js";
import { HWP_GENERATE_HWPX_TOOL_NAME, HWP_VALIDATE_TOOL_NAME, registerHwpGenerateHwpx, registerHwpValidate, } from "./write.js";
...
export function registerTools(server, definitions = toolDefinitions) {
