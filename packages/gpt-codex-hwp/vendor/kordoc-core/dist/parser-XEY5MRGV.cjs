...
function isProseSpread(items) {
  ...
  const maxGap = _chunkR2H34FY5cjs.safeMax.call(void 0, gaps);
...
function detectColumns(yLines) {
  ...
  if (allItems.length === 0) return null;
  const pageWidth = _chunkR2H34FY5cjs.safeMax.call(void 0, allItems.map((i) => i.x + i.w)) - _chunkR2H34FY5cjs.safeMin.call(void 0, allItems.map((i) => i.x));
...
function extractBlocksWithGrids(items, pageNum, grids, horizontals, verticals) {
  ...
  if (remaining.length > 0) {
    ...
    if (remaining.length > 0) {
      ...
      const pageH = _chunkR2H34FY5cjs.safeMax.call(void 0, allY) - _chunkR2H34FY5cjs.safeMin.call(void 0, allY);
...
function extractPageBlocksFallback(items, pageNum, fullPage = false) {
  ...
  if (clusterResults.length > 0) {
    ...
    if (columns && columns.length >= 3) {
      ...
      const pageHeight = _chunkR2H34FY5cjs.safeMax.call(void 0, allY) - _chunkR2H34FY5cjs.safeMin.call(void 0, allY);
  ...
  try {
    return await Promise.race([
      ...
      new Promise((_, reject) => {
        timer = setTimeout(() => {
          loadingTask.destroy();
          reject(new (0, _chunkR2H34FY5cjs.KordocError)("PDF \uB85C\uB529 \uD0C0\uC784\uC544\uC6C3 (30\uCD08 \uCD08\uACFC)"));
        }, PDF_LOAD_TIMEOUT_MS);
      })
    ]);
  } finally {
...
async function parsePdfDocument(buffer, options) {
  ...
  try {
    ...
    if (pageCount === 0) throw new (0, _chunkR2H34FY5cjs.KordocError)("PDF\uC5D0 \uD398\uC774\uC9C0\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.");
    ...
    for (let i = 1; i <= effectivePageCount; i++) {
      ...
      try {
        ...
        if (totalTextBytes > MAX_TOTAL_TEXT) throw new (0, _chunkR2H34FY5cjs.KordocError)("\uD14D\uC2A4\uD2B8 \uCD94\uCD9C \uD06C\uAE30 \uCD08\uACFC");
        parsedPages++;
        _optionalChain([options, 'optionalAccess', _36 => _36.onProgress, 'optionalCall', _37 => _37(parsedPages, totalTarget)]);
      } catch (pageErr) {
        if (pageErr instanceof _chunkR2H34FY5cjs.KordocError) throw pageErr;
    ...
    let markdown = cleanPdfText(_chunkR2H34FY5cjs.blocksToMarkdown.call(void 0, blocks));
    return {
      markdown,
      blocks,
      metadata,
...
//# sourceMappingURL=parser-XEY5MRGV.cjs.map