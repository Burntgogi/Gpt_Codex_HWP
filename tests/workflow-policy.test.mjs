...
test("CI runs bounded platform diagnostics only after the matching release gate fails", async () => {
  ...
  const largeEvidenceDiagnosticCommand = "npm --prefix packages/gpt-codex-hwp run benchmark:documents -- --validate-large .superpowers/benchmarks/release-large.json";
